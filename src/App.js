  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route
          exact
          path="/manager/home/createMatch"
          element={<AddFixtures />}
        />
        <Route
          exact
          path="/manager/home/createMatch/detailCreateMatch"
          element={<AddFixtureDetail />}
        />
        <Route
          exact
          path="/manager/home/createResult"
          element={<AddResult />}
        />
        <Route
          exact
          path="/manager/home/createResult/detailAddResult"
          element={<DetailAddResult />}
        />
        <Route
          exact
